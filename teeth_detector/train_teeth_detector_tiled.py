...
from tooth_detection_json_dataset_tiled import (
    ToothDetectionJsonDatasetTiled,
...
def main(
    ...
    # 1. Create Datasets
    train_dataset = ToothDetectionJsonDatasetTiled(
        root=train_dataset_path, transforms=get_transform(train=True), tile_size=640
    )

    val_dataset = ToothDetectionJsonDatasetTiled(
        root=val_dataset_path, transforms=get_transform(train=False), tile_size=640
    )
